...
model_eval = ModelEvalInterface(
    ...
    model_path="/home/weirdlab/ur_bc/robomimic/gello_transformer_chunk_seq_7_trained_models/test/20250216222545/models/model_epoch_100.pth",
)
model_eval.evaluate(blocking=True, freq=5, normalize=True, normalize_type='mean_std', transformer_model=True, frame_stack_size=10)
